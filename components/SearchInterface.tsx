        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-start justify-center pt-[10vh]">
          ...
          >
            ...
            <div>
                    ...
                    >
                      <Badge
                        ...
                        className={`cursor-pointer transition-all duration-150 ${
                          selectedTabIndex === index && isNavigatingTabs
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center space-x-3 px-4 py-3 cursor-pointer transition-colors duration-150 ${
                          selectedItemIndex === index && !isNavigatingTabs && !isFocusedOnSearch
              ...
              {/* Navigation Hints */}
              <div className="border-t px-4 py-2 bg-muted/30 rounded-b-xl">

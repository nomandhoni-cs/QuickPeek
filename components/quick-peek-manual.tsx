...
export default function QuickPeekManual() {
  return (
    <ClerkProvider
      ...
      afterSignOutUrl={`${EXTENSION_URL}/usermanual.html`}
      signInFallbackRedirectUrl={`${EXTENSION_URL}/usermanual.html`}
      signUpFallbackRedirectUrl={`${EXTENSION_URL}/usermanual.html`}
    >
      <div className="max-w-6xl mx-auto p-4 space-y-4 w-full h-screen">
        ...
        <div className="w-full">
          <SignedOut>
            <SignInButton
              fallbackRedirectUrl={`${EXTENSION_URL}/usermanual.html`}
            />
          </SignedOut>
          <SignedIn>
            <UserButton />
        ...
        <section>
          ...
          <p className="text-lg">
            ...
            bookmarks, and downloads, or to search the web directly. Activate
            the extension quickly using the keyboard shortcuts provided above.
          </p>
        </section>
      </div>
    </ClerkProvider>
